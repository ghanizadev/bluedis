...
electron_1.ipcMain.on("connect", function (event, options) { return __awaiter(void 0, void 0, void 0, function () {
    var host, port, password, tls, docs;
...
electron_1.ipcMain.on("addKey", function (event, key, type) { return __awaiter(void 0, void 0, void 0, function () {
    var docs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database.addKey(key, type)];
            case 1:
                _a.sent();
                return [4 /*yield*/, database.findAll()];
            case 2:
...
electron_1.ipcMain.on("changeString", function (event, key, value) { return __awaiter(void 0, void 0, void 0, function () {
    var docs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database.changeString(key, value)];
            case 1:
                _a.sent();
                return [4 /*yield*/, database.findAll()];
            case 2:
...
electron_1.ipcMain.on("getPreferences", function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var preferences;
    return __generator(this, function (_a) {
...
electron_1.ipcMain.on("find", function (event, match) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database.find(match)];
            case 1:
                docs = _a.sent();
                event.sender.send("data", docs);
                return [2 /*return*/];
