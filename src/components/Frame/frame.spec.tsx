...
describe('<Frame />', () => {
  ...
  it('Should have right title', () => {
    ...
    act(() => {
      ...
      store.dispatch(actions.currentConnection({
        host: 'localhost',
        port: '6379',
        tls: false,
        password: '',
    ...
    expect(screen.getByTestId('frame-titlebar')).toHaveTextContent('Bluedis - redis://localhost:6379');
    ...
    expect(screen.getByTestId('frame-titlebar')).toHaveTextContent('Bluedis - rediss://host:1234');
    ...
    expect(screen.getByTestId('frame-titlebar')).toHaveTextContent('Bluedis - rediss://host:1234 | [local]');
    ...
    act(() => {
      ...
      store.dispatch(actions.addFavorite({
        host: 'redis',
        port: '6379',
        tls: false,
        password: 'abcd123!',
    ...
    expect(screen.getByTestId('frame-titlebar')).toHaveTextContent('Bluedis - rediss://host:1234 | [the name]');
    ...
    expect(screen.getByTestId('frame-titlebar')).toHaveTextContent('Bluedis - redis://asbdiubegbwe...fasfsafasfeo:1234 | [gionrwigoren...wquibdqwiuvd]');
  })
})